...
public class DdParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DdGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAddExpressionAccess().getGroup_6(), "rule__AddExpression__Group_6__0");
			...
			builder.put(grammarAccess.getMultExpressionAccess().getGroup_6(), "rule__MultExpression__Group_6__0");
			...
			builder.put(grammarAccess.getCatExpressionAccess().getGroup_6(), "rule__CatExpression__Group_6__0");
			...
			builder.put(grammarAccess.getBinaryExpressionAccess().getExprValueAssignment_5_0(), "rule__BinaryExpression__ExprValueAssignment_5_0");
			builder.put(grammarAccess.getBinaryExpressionAccess().getPrecisionAssignment_5_1(), "rule__BinaryExpression__PrecisionAssignment_5_1");
			builder.put(grammarAccess.getBinaryExpressionAccess().getLengthAssignment_5_2(), "rule__BinaryExpression__LengthAssignment_5_2");
			builder.put(grammarAccess.getBinaryExpressionAccess().getHasAttributeAssignment_5_3(), "rule__BinaryExpression__HasAttributeAssignment_5_3");
			...
			builder.put(grammarAccess.getUnaryExpressionAccess().getExprValueAssignment_4_0(), "rule__UnaryExpression__ExprValueAssignment_4_0");
			builder.put(grammarAccess.getUnaryExpressionAccess().getPrecisionAssignment_4_1(), "rule__UnaryExpression__PrecisionAssignment_4_1");
			builder.put(grammarAccess.getUnaryExpressionAccess().getLengthAssignment_4_2(), "rule__UnaryExpression__LengthAssignment_4_2");
			builder.put(grammarAccess.getUnaryExpressionAccess().getHasAttributeAssignment_4_3(), "rule__UnaryExpression__HasAttributeAssignment_4_3");
			...
			builder.put(grammarAccess.getAddExpressionAccess().getExprValueAssignment_6_0(), "rule__AddExpression__ExprValueAssignment_6_0");
			builder.put(grammarAccess.getAddExpressionAccess().getPrecisionAssignment_6_1(), "rule__AddExpression__PrecisionAssignment_6_1");
			builder.put(grammarAccess.getAddExpressionAccess().getLengthAssignment_6_2(), "rule__AddExpression__LengthAssignment_6_2");
			builder.put(grammarAccess.getAddExpressionAccess().getHasAttributeAssignment_6_3(), "rule__AddExpression__HasAttributeAssignment_6_3");
			...
			builder.put(grammarAccess.getMultExpressionAccess().getExprValueAssignment_6_0(), "rule__MultExpression__ExprValueAssignment_6_0");
			builder.put(grammarAccess.getMultExpressionAccess().getPrecisionAssignment_6_1(), "rule__MultExpression__PrecisionAssignment_6_1");
			builder.put(grammarAccess.getMultExpressionAccess().getLengthAssignment_6_2(), "rule__MultExpression__LengthAssignment_6_2");
			builder.put(grammarAccess.getMultExpressionAccess().getHasAttributeAssignment_6_3(), "rule__MultExpression__HasAttributeAssignment_6_3");
			...
			builder.put(grammarAccess.getAndExpressionAccess().getExprValueAssignment_6_0(), "rule__AndExpression__ExprValueAssignment_6_0");
			builder.put(grammarAccess.getAndExpressionAccess().getHasAttributeAssignment_6_1(), "rule__AndExpression__HasAttributeAssignment_6_1");
			...
			builder.put(grammarAccess.getOrExpressionAccess().getExprValueAssignment_6_0(), "rule__OrExpression__ExprValueAssignment_6_0");
			builder.put(grammarAccess.getOrExpressionAccess().getHasAttributeAssignment_6_1(), "rule__OrExpression__HasAttributeAssignment_6_1");
			...
			builder.put(grammarAccess.getCatExpressionAccess().getExprValueAssignment_6_0(), "rule__CatExpression__ExprValueAssignment_6_0");
			builder.put(grammarAccess.getCatExpressionAccess().getLengthAssignment_6_1(), "rule__CatExpression__LengthAssignment_6_1");
			builder.put(grammarAccess.getCatExpressionAccess().getHasAttributeAssignment_6_2(), "rule__CatExpression__HasAttributeAssignment_6_2");
